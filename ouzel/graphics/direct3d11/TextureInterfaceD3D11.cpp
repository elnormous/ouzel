...
namespace ouzel
{
    namespace graphics
    {
        ...
        bool TextureInterfaceD3D11::setSize(const Size2& newSize)
        {
        ...
        bool TextureInterfaceD3D11::setData(const std::vector<uint8_t>& newData, const Size2& newSize)
        {
        ...
        bool TextureInterfaceD3D11::setFilter(Texture::Filter newFilter)
        {
        ...
        bool TextureInterfaceD3D11::setAddressX(Texture::Address newAddressX)
        {
        ...
        bool TextureInterfaceD3D11::setAddressY(Texture::Address newAddressY)
        {
        ...
        bool TextureInterfaceD3D11::setMaxAnisotropy(uint32_t newMaxAnisotropy)
        {
        ...
        bool TextureInterfaceD3D11::setClearColorBuffer(bool clear)
        {
        ...
        bool TextureInterfaceD3D11::setClearDepthBuffer(bool clear)
        {
        ...
        bool TextureInterfaceD3D11::setClearColor(Color color)
        {
        ...
        bool TextureInterfaceD3D11::createTexture()
        {
            if (texture)
            {
                texture->Release();
