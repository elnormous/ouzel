...
#ifndef DEPTHSTENCILSTATERESOURCEOGL_HPP
#define DEPTHSTENCILSTATERESOURCEOGL_HPP
...
namespace ouzel
{
    namespace graphics
    {
        ...
        class DepthStencilStateResourceOGL final: public RenderResourceOGL
        {
        public:
            DepthStencilStateResourceOGL(RenderDeviceOGL& renderDeviceOGL,
                                         bool initDepthTest,
                                         bool initDepthWrite,
...
#endif // DEPTHSTENCILSTATERESOURCEOGL_HPP
