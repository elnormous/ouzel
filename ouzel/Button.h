...
namespace ouzel
{
    ...
    public:
        ...
        virtual bool init(std::string const& normal, std::string const& selected, std::string const& pressed, std::string const& disabled, std::function<void(std::shared_ptr<void>)> const& callback = std::function<void(std::shared_ptr<void>)>());
    ...
    protected:
        ...
        std::shared_ptr<Sprite> _disabledSprite;
