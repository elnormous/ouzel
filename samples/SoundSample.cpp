...
SounSample::SounSample(Application& app):
    application(app)
{
    eventHandler = make_shared<EventHandler>();
    eventHandler->uiHandler = bind(&SounSample::handleUI, this, placeholders::_1, placeholders::_2, placeholders::_3);
...
SounSample::~SounSample()
{
    sharedEngine->getEventDispatcher()->removeEventHandler(eventHandler);
}

bool SounSample::handleUI(Event::Type type, const UIEvent& event, const VoidPtr& sender) const
{
    OUZEL_UNUSED(event);
