    ...
    perspectiveButton("button.png", "button_selected.png", "button_down.png", "", "Perspective", "arial.fnt", 1.0F, Color(20, 0, 0, 255), Color::BLACK, Color::BLACK)
{
    ...
    camera.setTargetContentSize(Size2<float>(400.0F, 600.0F));
    cameraActor.addComponent(&camera);
    layer.addChild(&cameraActor);

    layer.addChild(&menu);

    gitHubButton.setPosition(Vector2<float>(0.0F, 120.0F));
    menu.addWidget(&gitHubButton);

    spritesButton.setPosition(Vector2<float>(0.0F, 80.0F));
    menu.addWidget(&spritesButton);

    guiButton.setPosition(Vector2<float>(0.0F, 40.0F));
    menu.addWidget(&guiButton);

    renderTargetButton.setPosition(Vector2<float>(0.0F, 0.0F));
    menu.addWidget(&renderTargetButton);

    animationsButton.setPosition(Vector2<float>(0.0F, -40.0F));
    menu.addWidget(&animationsButton);

    inputButton.setPosition(Vector2<float>(0.0F, -80.0F));
    menu.addWidget(&inputButton);

    soundButton.setPosition(Vector2<float>(0.0F, -120.0F));
    menu.addWidget(&soundButton);

    perspectiveButton.setPosition(Vector2<float>(0.0F, -160.0F));
