...
namespace ouzel
{
    namespace visualstudio
    {
        inline void generateBuildFiles(const Project& project)
        {
            ...
            const auto libouzelProject = VcxProject(libouzelUuid, cppProjectGuid, "libouzel", storage::Path{"libouzel.vxxproj"}, {});
            const auto ouzelProject = VcxProject(ouzelUuid, cppProjectGuid, "ouzel", storage::Path{"ouzel.vxxproj"}, {});
