...
namespace ouzel::graphics::d3d11
{
        ...
        graphics::RenderDevice{Driver::direct3D11, settings, initWindow}
    {
        ...
        swapChainDesc.Windowed = (window.isExclusiveFullscreen() && window.isFullscreen()) ? FALSE : TRUE;
        ...
        factory->MakeWindowAssociation(window.getNativeWindow(), DXGI_MWA_NO_ALT_ENTER);
