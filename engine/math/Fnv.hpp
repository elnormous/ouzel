...
namespace ouzel
{
    namespace fnv
    {
        inline namespace detail
        {
            ...
            template <> constexpr uint32_t prime<uint32_t>() { return 16777619u; }
            template <> constexpr uint32_t offsetBasis<uint32_t>() { return 2166136261u; }
                template <> constexpr uint64_t prime<uint64_t>() { return 1099511628211u; }
                template <> constexpr uint64_t offsetBasis<uint64_t>() { return 14695981039346656037u; }
        }
